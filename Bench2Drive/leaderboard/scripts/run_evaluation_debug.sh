...
# TEAM_AGENT=leaderboard/team_code_zoo/your_team_agent.py   # 1. change
TEAM_AGENT=leaderboard/team_code_zoo/vad_b2d_agent.py  # 1. change

# TEAM_CONFIG=your_team_agent_ckpt.pth   # for TCP and ADMLP  # 2. change
