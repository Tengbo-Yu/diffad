...
_URL_WEIGHTS = os.path.abspath(os.path.dirname(__file__))

# URL prefix for model config files
_URL_CONFIGS = os.path.abspath(os.path.dirname(__file__))
...
_MODEL_ZOO_WEIGHTS = {
    "RegNetX-800MF": "dds_baselines/RegNetX-800MF_dds_8gpu.pyth",
