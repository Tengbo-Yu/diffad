...
from mmdet.utils import track_iter_progress, mkdir_or_exist
...
from mmdet.datasets.data_utils.vector_map import VectorizedLocalMap
from mmdet.datasets.data_utils.rasterize import preprocess_map
...
class NuScenesE2EDataset(NuScenesDataset):
    ...
    def load_annotations(self, ann_file):
        ...
        if self.file_client_args['backend'] == 'disk':
            # data_infos = mmdet.load(ann_file)
