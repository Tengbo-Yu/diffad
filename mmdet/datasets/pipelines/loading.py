...
from mmdet.core.points import BasePoints, get_points_type
from mmdet.fileio.file_client import FileClient
from mmdet.image.io import imfrombytes, imread
from mmdet.utils.path import check_file_exist
...
class LoadImageFromFile:
    ...
    Args:
        to_float32 (bool): Whether to convert the loaded image to a float32
            ...
            Defaults to False.
        color_type (str): The flag argument for :func:`mmdet.imfrombytes`.
            Defaults to 'color'.
        file_client_args (dict): Arguments to instantiate a FileClient.
            See :class:`mmdet.fileio.FileClient` for details.
...
class LoadPointsFromMultiSweeps(object):
    ...
    Args:
        ...
        file_client_args (dict): Config dict of file clients, refer to
            https://github.com/open-mmlab/mmdet/blob/master/mmdet/fileio/file_client.py
...
class LoadMultiViewImageFromFilesInCeph(object):
    ...
    def __call__(self, results):
        ...
        # img is of shape (h, w, c, num_views)
        img = np.stack(
            #[mmdet.imread(name, self.color_type) for name in filename], axis=-1)
...
class CustomLoadPointsFromMultiSweeps:
    ...
    def _load_points(self, lidar_path):
        ...
        Returns:
            np.ndarray: An array containing point clouds data.
        """
        mmdet.check_file_exist(lidar_path)
