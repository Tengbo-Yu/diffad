...
import warnings
from mmdet.utils.misc import is_tuple_of
from mmdet.utils.registry import build_from_cfg
from mmdet.parallel.data_container import DataContainer as DC

from mmdet.core.bbox.structures.cam_box3d import CameraInstance3DBoxes
from mmdet.core.bbox.structures.lidar_box3d import LiDARInstance3DBoxes
from mmdet.core.bbox import box_np_ops
from mmdet.datasets.builder import PIPELINES
from mmdet.image.geometric import impad, impad_to_multiple,imresize
from mmdet.image.photometric import imnormalize
from mmdet.image.colorspace import bgr2hsv, hsv2bgr
from mmdet.datasets.builder import OBJECTSAMPLERS
...
class PointSample(object):
    ...
    def __call__(self, results):
        ...
        if self.sample_range is not None:
            from mmdet.core.points import CameraPoints
...
class CustomCollect3D(object):
    ...
    Args:
        ...
        meta_keys (Sequence[str], optional): Meta keys to be converted to
            ``mmdet.DataContainer`` and collected in ``data[img_metas]``.
    ...
    def __init__(self,
                 ...
                 meta_keys=('filename', 'ori_shape', 'img_shape', 'lidar2img',
                            ...
                            'can_bus','folder','frame_idx', 'timestamp'
                            )):
    ...
    def __call__(self, results):
        ...
        will be converted to :obj:`mmdet.DataContainer`.
        Args:
