...
from mmdet.core.bbox.structures.base_box3d import BaseInstance3DBoxes
from mmdet.core.points import BasePoints
from mmdet.utils.misc import is_str
...
class ToDataContainer:
    """Convert results to :obj:`mmdet.DataContainer` by given fields.

    Args:
        fields (Sequence[dict]): Each field is a dict like
            ``dict(key='xxx', **kwargs)``. The ``key`` in result will
            be converted to :obj:`mmdet.DataContainer` with ``**kwargs``.
