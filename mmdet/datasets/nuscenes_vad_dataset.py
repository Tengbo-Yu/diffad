...
from mmdet.fileio.io import dump,load
import numpy as np
from .builder import DATASETS
from mmdet.datasets import NuScenesDataset
import pyquaternion
import mmdet
...
from mmdet.utils.visual import save_tensor
...
from mmdet.core.bbox.structures.nuscenes_box import CustomNuscenesBox
...
class VADCustomNuScenesDataset(NuScenesDataset):
    ...
    def get_map_classes(cls, map_classes=None):
        ...
        if isinstance(map_classes, str):
            ...
            class_names = mmdet.list_from_file(map_classes)
    ...
    def _format_gt(self):
        ...
        if (not os.path.exists(self.map_ann_file)) :
            ...
            prog_bar = mmdet.ProgressBar(dataset_length)
    ...
    def _evaluate_single(self,
        ...
        from mmdet.datasets.map_utils.mean_ap import eval_map
        from mmdet.datasets.map_utils.mean_ap import format_res_gt_by_classes
