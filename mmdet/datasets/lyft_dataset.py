...
from mmdet.core.evaluation.lyft_eval import lyft_eval
from mmdet.datasets import DATASETS
from mmdet.core import show_result
# from mmdet.core.bbox import Box3DMode, Coord3DMode, LiDARInstance3DBoxes
from mmdet.core.bbox.structures.box_3d_mode import Box3DMode
from mmdet.core.bbox.structures.coord_3d_mode import Coord3DMode
...
class LyftDataset(Custom3DDataset):
    ...
    def _format_bbox(self, results, jsonfile_prefix=None):
        ...
        for sample_id, det in enumerate(mmdet.track_iter_progress(results)):
            annos = []
        ...
        mmdet.mkdir_or_exist(jsonfile_prefix)
        res_path = osp.join(jsonfile_prefix, 'results_lyft.json')
        print('Results writes to', res_path)
        mmdet.dump(lyft_submissions, res_path)
        return res_path
    ...
    def json2csv(self, json_path, csv_savepath):
        ...
        """
        results = mmdet.load(json_path)['results']
        ...
        mmdet.mkdir_or_exist(os.path.dirname(csv_savepath))
