...
from mmdet.datasets.utils import extract_result_dict, get_loading_pipeline
from mmdet.fileio.io import load, dump
from mmdet.fileio.parse import list_from_file
...
class Custom3DDataset(Dataset):
    ...
    def evaluate(self,
        ...
        """
        from mmdet.core.evaluation import indoor_eval
        assert isinstance(
