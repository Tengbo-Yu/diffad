...
from mmdet.utils.misc import has_method
from mmdet.utils.path import is_filepath, mkdir_or_exist
...
class CephBackend(BaseStorageBackend):
    ...
    .. warning::
        :class:`mmdet.fileio.file_client.CephBackend` will be deprecated,
        please use :class:`mmdet.fileio.file_client.PetrelBackend` instead.
    """
